...
def upgrade() -> None:
    ...
    with op.batch_alter_table('events', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_events_dest_ip'), ['dest_ip'], unique=False)
        batch_op.create_index(batch_op.f('ix_events_event_type'), ['event_type'], unique=False)
        batch_op.create_index(batch_op.f('ix_events_flow_id'), ['flow_id'], unique=False)
    ...
    with op.batch_alter_table('statistics', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_statistics_timestamp'), ['timestamp'], unique=True)
    ...
    with op.batch_alter_table('alerts', schema=None) as batch_op:
        ...
        batch_op.create_index('idx_alerts_timestamp_severity', ['timestamp', 'severity'], unique=False)
        batch_op.create_index(batch_op.f('ix_alerts_category'), ['category'], unique=False)
        batch_op.create_index(batch_op.f('ix_alerts_dst_port'), ['dst_port'], unique=False)
        batch_op.create_index(batch_op.f('ix_alerts_flow_id'), ['flow_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_alerts_protocol'), ['protocol'], unique=False)
        batch_op.create_index(batch_op.f('ix_alerts_severity'), ['severity'], unique=False)
        batch_op.create_index(batch_op.f('ix_alerts_signature_id'), ['signature_id'], unique=False)
